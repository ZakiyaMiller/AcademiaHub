...
mongoose
  .connect(
    process.env.MONGODB_URI || "mongodb://localhost:27017/academiaHub",
    {
...
// Search Route for both Students and Courses
app.get("/api/search", async (req, res) => {
  try {
    const searchTerm = req.query.q;
    logger.info("Search initiated:", { searchTerm });
    ...
    logger.info("Search completed:", {
      searchTerm,
      studentResultsCount: students.length,
      courseResultsCount: courses.length,
    });
